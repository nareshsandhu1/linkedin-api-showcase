...
const ENTRIES = [
  ...
  ['r_ads',                          'Marketing Developer Platform', 'Retrieve advertising accounts.', [
    { method: 'GET', path: 'https://api.linkedin.com/rest/adAccounts', label: 'Ad Accounts' },
  ]],
  ['rw_ads',                         'Marketing Developer Platform', 'Manage advertising accounts, campaigns, and creatives.', [
    { method: 'GET',  path: 'https://api.linkedin.com/rest/adAccounts', label: 'Ad Accounts' },
  ...
  ['r_ads_reporting',                'Marketing Developer Platform', 'Retrieve reporting/analytics for advertising accounts.', [
    { method: 'GET', path: 'https://api.linkedin.com/rest/adAnalytics?q=analytics', label: 'Ad Analytics' },
  ]],
  ['r_1st_connections_size',         'Marketing Developer Platform', 'Read the size of the member’s 1st-degree network.', [
  ...
  ['rw_offlineConversions',  'Conversions API (Offline)', 'Upload offline conversion data and manage offline conversion tracking.', [
    { method: 'POST', path: 'https://api.linkedin.com/rest/conversionEvents', label: 'Offline Conversion Events' },
  ]],
