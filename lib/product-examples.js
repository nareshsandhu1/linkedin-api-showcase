...
X-Restli-Protocol-Version: 2.0.0`,
  ...
  'Company Intelligence API': {
    request: `GET https://api.linkedin.com/rest/accountIntelligence?q=account&start=0&count=10&account=urn%3Ali%3AsponsoredAccount%3A506336348&filterCriteria=(lookbackWindow:LAST_90_DAYS)
Authorization: Bearer {ACCESS_TOKEN}
  ...
  "elements": [
    {
      ...
      "paidEngagements": 600,
      "paidLeads": 80,
      "paidQualifiedLeads": 8,
      "conversions": 18,
      "paidVideoViews": 160,
      "organicImpressions": 100,
      "organicEngagements": 100,
      "companySize": "SIZE_10001_OR_MORE",
      "industry": "urn:li:industry:4",
      "countryCode": "US",
      "costInLocalCurrencyPerPaidQualifiedLead": 145.5
    }
  ],
  "paging": {
    "count": 10,
    ...
    "links": [
      {
        ...
        "href": "/rest/accountIntelligence?q=account&filterCriteria=(lookbackWindow:LAST_90_DAYS)&start=10&count=10&account=urn%3Ali%3AsponsoredAccount%3A506336348"
      }
    ]
  }
}`,
...
LinkedIn-Version: 202506`,
  ...
  'Audience Insights API': {
    request: `POST https://api.linkedin.com/rest/targetingAudienceInsights?action=audienceInsights
Authorization: Bearer {ACCESS_TOKEN}
LinkedIn-Version: 202506
X-Restli-Protocol-Version: 2.0.0
Content-Type: application/json

{
  "request": {
    "requestMetaData": {
      "sponsoredAccount": "urn:li:sponsoredAccount:506336348"
    },
    "targetingCriteria": {
      "include": {
        "and": [
          ...
          { "or": { "urn:li:adTargetingFacet:skills": ["urn:li:skill:236", "urn:li:skill:242", "urn:li:skill:252"] } }
        ]
      }
    },
  ...
  "value": {
    "audienceInsight": {
      ...
      "segmentations": [
        { "value": "urn:li:function:4",  "entityCount": 96000, "entityPercentage": 23 },
        { "value": "urn:li:function:20", "entityCount": 61000, "entityPercentage": 15 },
        { "value": "urn:li:function:18", "entityCount": 55000, "entityPercentage": 13 },
        { "value": "urn:li:function:13", "entityCount": 40000, "entityPercentage": 10 },
        { "value": "urn:li:function:5",  "entityCount": 31000, "entityPercentage": 7 }
      ]
    },
