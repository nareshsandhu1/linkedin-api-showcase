...
module.exports = {
  ...
  'POST https://api.linkedin.com/rest/conversionEvents': {
    paramSchema: {
      baseUrl: 'https://api.linkedin.com/rest/conversionEvents',
      httpMethod: 'POST',
      bodyShape: 'conversionEvent',
      description:
        'Stream an offline/CRM conversion event to LinkedIn. Identify the member with one or more user identifiers (hashed email, click ID, etc.) and optionally add user info to improve match rates. Fill in only the fields you have — empty fields are omitted from the request body.',
      fields: [
        { type: 'heading', label: 'Conversion' },
        {
          ...
          type: 'text',
          required: true,
          default: 'urn:lla:llaPartnerConversion:123456',
          hint: 'Conversion rule ID or full urn:lla:llaPartnerConversion:ID. Find it in Campaign Manager or via Find Conversion Rules by Ad Account. A bare ID is wrapped into the URN for you.',
        },
        {
          key: 'conversionHappenedAt',
          label: 'Conversion happened at (epoch ms)',
          type: 'text',
          hint: 'Milliseconds since epoch, within the past 90 days. Leave blank to use the current time.',
        },
        {
          key: 'eventId',
          label: 'Event ID (optional, for dedup)',
          type: 'text',
          default: '',
          hint: 'Your unique identifier for this event, used to deduplicate.',
        },

        { type: 'heading', label: 'Conversion value (optional)' },
        {
          key: 'amount',
          label: 'Amount',
          type: 'text',
          default: '',
          hint: 'Decimal string, e.g. 49.99. Conversion value is only sent when an amount is provided.',
        },
        {
          key: 'currencyCode',
          label: 'Currency code',
          type: 'text',
          default: 'USD',
          hint: 'ISO currency code, e.g. USD.',
        },

        { type: 'heading', label: 'User identifiers (provide at least one)' },
        {
          key: 'email',
          label: 'Email (hashed to SHA256 for you)',
          type: 'text',
          default: '',
          hint: 'Plain email — lowercased, stripped of whitespace and SHA-256 hashed in your browser, then sent as SHA256_EMAIL. The raw email never leaves your browser.',
        },
        {
          key: 'liFatId',
          label: 'Click ID (li_fat_id)',
          type: 'text',
          default: '',
          hint: 'Sent as LINKEDIN_FIRST_PARTY_ADS_TRACKING_UUID — the li_fat_id value appended to click URLs when enhanced conversion tracking is enabled.',
        },
        {
          key: 'acxiomId',
          label: 'Acxiom ID',
          type: 'text',
          default: '',
          hint: 'Sent as ACXIOM_ID for LiveRamp identity-graph matching.',
        },
        {
          key: 'ipAddress',
          label: 'IP address',
          type: 'text',
          default: '',
          hint: 'Sent as PLAINTEXT_IP_ADDRESS (IPv4 only). LinkedIn hashes it with salt before matching.',
        },
        {
          key: 'googleAid',
          ...
          type: 'text',
          default: '',
          hint: 'Sent as GOOGLE_AID for Android device matching.',
        },

        { type: 'heading', label: 'User info (optional — improves match; requires both first & last name)' },
        { key: 'firstName', label: 'First name', type: 'text', default: '' },
        { key: 'lastName', label: 'Last name', type: 'text', default: '' },
        ...
        { key: 'title', label: 'Title', type: 'text', default: '' },
        {
          ...
          type: 'text',
          default: '',
          hint: 'ISO two-letter country code, e.g. US.',
        },

        { type: 'heading', label: 'Other matching (optional)' },
        {
          key: 'lead',
          label: 'Lead Gen Form Response URN',
          type: 'text',
          default: '',
          hint: 'urn:li:leadGenFormResponse:ID',
        },
        {
          key: 'externalId',
          label: 'External ID',
          type: 'text',
          default: '',
          hint: 'Advertiser-provided identifier representing the user.',
        },
      ],
    },
  },
